...
int main()
{
    ...
    // This displays all the information the user inputed.
    ...
    // This combines all of the information the user inputed into one fun sentence related to creative writing.
